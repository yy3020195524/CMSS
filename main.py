...
def main():
    ...
    parser.add_argument("--checkpoint", default="./test_250/2_epoch/model_final.pt", type=str,
    ...
    parser.add_argument('--fusion_start_epoch', default=400, type=int)
    ...
    diceCELoss = DiceCELoss(to_onehot_y=True, softmax=True, squared_pred=True, smooth_nr=args.smooth_nr,
